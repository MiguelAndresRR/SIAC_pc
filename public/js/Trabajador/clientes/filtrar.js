//Este script en JavaScript se ejecuta al cargar el DOM y se encarga de gestionar los filtros dinámicos de clientes en una tabla. Primero, 
...
// actualizando la tabla de clientes sin recargar la página. Además, 
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function filtro() {
        ...
        fetch(`/user/clientes/index?${params}`, {
            headers: {
