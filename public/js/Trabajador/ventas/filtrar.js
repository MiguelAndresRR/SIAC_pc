//Este script en JavaScript se ejecuta al cargar el DOM y se encarga de gestionar los filtros dinámicos de los ventas en una tabla. Primero, 
...
// actualizando la tabla de los ventas sin recargar la página. Además, 
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function filtro() {
        ...
        fetch(`/user/ventas/index?${params}`, {
            headers: {
    ...
    if (pdfBtn) {
        pdfBtn.addEventListener("click", function (e) {
            ...
            const pdfUrl = `/user/ventas/pdf?${params}`;
