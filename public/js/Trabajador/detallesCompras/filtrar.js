//Este script en JavaScript se ejecuta al cargar el DOM y se encarga de gestionar los filtros dinámicos de los detalles de una compra en una tabla. Primero, 
...
// actualizando la tabla de los detalles de una compra sin recargar la página. Además, 
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function filtro() {
        ...
        fetch(`/user/compras/${idCompra}/detalles/?${params}`, {
            headers: {
