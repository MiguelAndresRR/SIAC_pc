//Este script en JavaScript se ejecuta al cargar el DOM y se encarga de gestionar los filtros dinámicos de los detalles de una venta en una tabla. Primero, 
...
// actualizando la tabla de los detalles de una venta sin recargar la página. Además, 
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    if (!form) {
        console.error("No se encontró el formulario filtro-form-detallesVentas");
        return;
    }
    ...
    function filtro() {
        ...
        const idVenta = form.dataset.id_venta_detalle;
        fetch(`/admin/ventas/${idVenta}/detalles/?${params}`, {
            headers: {
            ...
            .then((res) => res.text())
            .then((html) => {
                document.getElementById("tabla-detallesVentas").innerHTML = html;
    ...
    if (limpiarBtn) {
        ...
        console.error("No se encontró el botón limpiar-filtros-detallesVentas");
    }
