                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="apellido_usuario-editar" name="apellido_usuario"
                                value="{{ old('apellido_usuario') }}" placeholder="Apellido" maxlength="50" required>
                        </div>

                        <div class="form-group">
                            <label for="documento_usuario-editar" class="form-label"><i class="fa-solid fa-id-card"></i> Documento</label>
                            <input type="number" class="form-control" id="documento_usuario-editar" name="documento_usuario"
                                value="{{ old('documento_usuario') }}" placeholder="Número de documento" required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="tel" class="form-control" id="telefono_usuario-editar" name="telefono_usuario"
                                value="{{ old('telefono_usuario') }}" placeholder="Teléfono" maxlength="10"
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control" id="correo_usuario-editar" name="correo_usuario"
                                value="{{ old('correo_usuario') }}" placeholder="Correo electrónico" maxlength="50" required>
                        </div>
                    </div>
                </div>
