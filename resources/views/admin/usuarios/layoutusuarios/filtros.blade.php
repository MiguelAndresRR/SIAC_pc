<form id="filtro-form-usuarios" class="filtros" method="GET">
    ...
    <div class="filtros">
        ...
        <input type="text" id="nombre_usuario-buscar" name="buscar_nombre" class="form-control"
            placeholder="Buscar nombres o apellidos...">
        <input type="text" id="documento_usuario-buscar" name="buscar_documento" class="form-control"
