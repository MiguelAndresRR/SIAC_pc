...
<body>
    ...
    <div class="content-proveedores">
        ...
        @include('admin.proveedores.layoutproveedores.filtros')
        <div id="tabla-proveedores">
            @include('admin.proveedores.layoutproveedores.tablaproveedores')
        </div>
    </div>
    @include('admin.proveedores.modal.edit')
    @include('admin.proveedores.modal.mostrar')
    @include('admin.proveedores.modal.create')
    <script src="{{ asset('js/proveedores/crear.js') }}"></script>
    <script src="{{ asset('js/proveedores/editar.js') }}"></script>
    <script src="{{ asset('js/proveedores/showboton.js') }}"></script>
