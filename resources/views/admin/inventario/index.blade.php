...
<body>
    ...
    <!-- Scripts JavaScript -->
    <script src="{{ asset('js/inventario/crear.js') }}"></script>
    <script src="{{ asset('js/inventario/editar.js') }}"></script>
    <script src="{{ asset('js/inventario/showboton.js') }}"></script>
    <script src="{{ asset('js/inventario/borrar.js') }}"></script>
    <script src="{{ asset('js/inventario/filtrar.js') }}"></script>
