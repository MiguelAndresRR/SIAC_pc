...
<body>
    ...
    <div class="content-usuarios">
        ...
        @include('user.usuarios.layoutusuarios.filtros')
        <div id="tabla-usuarios">
            @include('user.usuarios.layoutusuarios.tablausuarios')
        </div>
    </div>


    <script src="{{ asset('js/Trabajador/usuarios/filtrar.js') }}"></script>
