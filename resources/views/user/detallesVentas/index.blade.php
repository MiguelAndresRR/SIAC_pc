...
<body>
    ...
    <div class="content-detallesVentas">
        <div class="header">
            ...
            <div class="header-detallesVentas">
                <a href="{{ route('user.ventas.index') }}" class="btn-back">
                    <i class="fa-regular fa-circle-left"></i>
                </a>
            </div>
            <h1 class="Totalventa">Total Venta: COP{{ $venta->total_venta }}</h1>
        </div>
        @include('user.detallesVentas.layoutdetallesVentas.filtros')
        <div id="tabla-detallesVentas">
            @include('user.detallesVentas.layoutdetallesVentas.tabladetallesVentas')
        </div>
    </div>
