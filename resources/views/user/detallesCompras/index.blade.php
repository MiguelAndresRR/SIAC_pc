...
<body>
    ...
    <div class="content-detallesCompras">
        <div class="header">
            ...
            <div class="header-detallesCompras">
                <a href="{{ route('user.compras.index') }}" class="btn-back">
                    <i class="fa-regular fa-circle-left"></i>
                </a>
            </div>
            <h1 class="TotalCompra">Total Compra: COP{{ $total_compra }}</h1>
        </div>
        @include('user.detallesCompras.layoutdetallesCompras.filtros')
        <div id="tabla-detallesCompras">
            @include('user.detallesCompras.layoutdetallesCompras.tabladetallesCompras')
        </div>
    </div>
    <script src="https://cdn.jsdelivr.net/npm/tom-select@2.2.2/dist/js/tom-select.complete.min.js"></script>
    <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
    <script src="https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/js/select2.min.js"></script>
    <script src="{{ asset('js/Trabajador/detallesCompras/filtrar.js') }}"></script>
</body>
