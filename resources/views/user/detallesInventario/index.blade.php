...
<body>
    ...
    <div class="content-inventario">
        <div class="header">
            ...
            <div class="header-detallesInventario">
                <a href="{{ route('user.inventario.index') }}" class="btn-back">
                    <i class="fa-regular fa-circle-left"></i>
                </a>
            </div>
        </div>
        @include('user.detallesInventario.layoutDetallesInventario.filtros')
        <div id="tabla-inventario">
            @include('user.detallesInventario.layoutDetallesInventario.tablaDetallesInventario')
        </div>
    </div>
