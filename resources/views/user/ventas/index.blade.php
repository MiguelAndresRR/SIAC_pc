...
<body>
    ...
    <div class="content-ventas">
        <div class="header">
            ...
            <a onclick="window.location.href='{{ route('admin.reportes.ventas_pdf') }}'" class="pdfGenerar">
                <i class="fa fa-file-pdf"></i> Generar PDF
            </a>
        </div>
        @include('user.ventas.layoutventas.filtros')
        <div id="tabla-ventas">
            @include('user.ventas.layoutventas.tablaventas')
        </div>
    </div>
    <script src="{{ asset('js/Trabajador/ventas/filtrar.js') }}"></script>
</body>
