...
<body>
    ...
    <div class="content-clientes">
        ...
        @include('user.clientes.layoutclientes.filtros')
        <div id="tabla-clientes">
            @include('user.clientes.layoutclientes.tablaclientes')
        </div>
    </div>


    <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
    <script src="{{ asset('js//Trabajador/clientes/filtrar.js') }}"></script>
</body>
</html>
